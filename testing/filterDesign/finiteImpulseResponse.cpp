    ...
    double)
{
    ...
    SECTION("Order 16")
    {
        ...
        ( 
            std::vector<std::complex<TestType>>
                                   {std::complex<TestType> (0, -0.000000000000000),
                                    std::complex<TestType> (0, -0.002154949073886),
                                    std::complex<TestType> (0, -0.000000000000000),
                                    std::complex<TestType> (0, -0.025048021740503),
                                    std::complex<TestType> (0, -0.000000000000000),
                                    std::complex<TestType> (0, -0.123110554263836),
                                    std::complex<TestType> (0, -0.000000000000000),
                                    std::complex<TestType> (0, -0.600346453738133),
    ...
    SECTION("Order 19")
    {
        ...
        (
            std::vector<std::complex<TestType>>
                                   {
                                      std::complex<TestType> (-0.000078362668030 , -0.000078362668030),
                                      std::complex<TestType> ( 0.000687065652501 , -0.000687065652501),
                                      std::complex<TestType> (-0.002495774178985 , -0.002495774178985),
                                      std::complex<TestType> ( 0.006621258126556 , -0.006621258126556),
                                      std::complex<TestType> (-0.014693594258722 , -0.014693594258722),
                                      std::complex<TestType> ( 0.029092392815675 , -0.029092392815675),
                                      std::complex<TestType> (-0.053803945082584 , -0.053803945082584),
                                      std::complex<TestType> ( 0.097839237445465 , -0.097839237445464),
                                      std::complex<TestType> (-0.193197503788858 , -0.193197503788858),
                                      std::complex<TestType> ( 0.630029225936982 , -0.630029225936981),
                                      std::complex<TestType> ( 0.630029225936982 ,  0.630029225936981),
                                      std::complex<TestType> (-0.193197503788858 ,  0.193197503788858),
                                      std::complex<TestType> ( 0.097839237445465 ,  0.097839237445464),
                                      std::complex<TestType> (-0.053803945082584 ,  0.053803945082584),
